...
func Register_Hello_GRPCServer(srv HelloGRPCServer) server.Option {
...
func createHelloHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(HelloGRPCServer).CreateHello(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateHelloHello1RequestArgs:
		success, err := handler.(HelloGRPCServer).CreateHello(ctx, s.Req)
		if err != nil {
			return err
		}
