...
var FxServiceModule = fx.Module("fx-service",
	...
	fx.Provide(
		fx.Annotate(
			func() mw.Middleware { return mw.LoggingMiddleware },
		...
		fx.Annotate(
			func(tmCtx *TmMiddlewareContext) mw.Middleware { return tmCtx.TransactionMiddleware },
...
type FxGreeterMiddleware struct {
	...
	CustomMws []mw.Middleware `group:"fx_greeter_service_middleware" ,optional:"true"`
}
...
type FxHelloMiddleware struct {
	BaseFxMiddlewareParams
	CustomMws []mw.Middleware `group:"fx_hello_service_middleware" ,optional:"true"`
}
